...
#include "GenericPlusRotor.h"

irr::scene::ISceneNode *GenericPlusRotor::createFrameSceneNode(){
	irr::scene::IAnimatedMeshSceneNode *n = (irr::scene::IAnimatedMeshSceneNode*)Multirotor::createFrameSceneNode(); 

	n->setMesh(_application->getSceneManager()->getMesh("frame_quad_+.obj")); 

	return n; 
}

void GenericPlusRotor::setupMotors(){
